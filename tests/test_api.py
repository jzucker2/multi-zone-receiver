"""Tests for Multi Zone Receiver api."""
import asyncio

import aiohttp
from custom_components.multi_zone_receiver.api import (
    MultiZoneReceiverApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = MultiZoneReceiverApiClient("test", "test", async_get_clientsession(hass))
