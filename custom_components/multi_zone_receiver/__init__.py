...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    coordinator = MultiZoneReceiverDataUpdateCoordinator(hass, client=client)
...
class MultiZoneReceiverDataUpdateCoordinator(DataUpdateCoordinator):
    """Class to manage fetching data from the API."""

    def __init__(
        self,
        hass: HomeAssistant,
        client: MultiZoneReceiverApiClient,
    ) -> None:
        """Initialize."""
        self.api = client
        self.platforms = []
